...
function renderTrial() {
    ...
    if (state.currentRule === 'COLOR') {
        ...
        btnLeft.style.background = "#0984e3";
        btnRight.textContent = "Orange";
        btnRight.style.background = "#e17055";
    } else {
        btnLeft.textContent = "Circle";
        btnLeft.style.background = "#636e72";
        btnRight.textContent = "Square";
        btnRight.style.background = "#636e72";
    }
}
...
function handleInput(side) {
    ...
    if (isCorrect) {
        ...
        ruleDisplay.style.background = "#e74c3c";
